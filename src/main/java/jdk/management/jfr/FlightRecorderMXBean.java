...
public interface FlightRecorderMXBean extends PlatformManagedObject {
     ...
     * obtained by invoking {@link EventType#getId()} method and is valid
     ...
     * {@link EventType#getName()}. A list of available settings for an
     * event type is obtained by invoking
     * {@link EventType#getSettingDescriptors()} and
